<template>
  <div
    class="container"
    role="status"
    aria-label="App is loading. Please, wait"
    tabindex="0"
  >
    <svg
      fill="none"
    ...
    >
      <g fill="currentColor">
        <path
          d="m8.192 21.44h-6.016v-11.2h-2.176v-4.928h2.304c.64-3.04 3.616-5.312 8.896-5.312h1.28v4.288h-2.24c-1.664 0-2.464.16-2.432 1.024h4.672v4.928h-4.288z"
        />
        <path
          d="m20.1047 3.84h-6.016v-3.84h6.016zm0 17.6h-6.016v-16.128h6.016z"
        />
        <path
          d="m28.3622 21.44h-6.016v-16.128h5.6321v4.896h.32c.3519-2.688 2.112-5.216 6.432-5.216 4.352 0 6.3999 2.624 6.3999 6.112v10.336h-6.0159v-8.128c0-2.24-.8321-2.944-3.4561-2.944-2.656 0-3.296.672-3.296 2.752z"
        />
        <path
        ...
        />
        <path
          d="m68.596 21.44h-6.016v-16.128h5.632v4.896h.32c.352-2.688 2.112-5.216 6.432-5.216 4.352 0 6.4 2.624 6.4 6.112v10.336h-6.016v-8.128c0-2.24-.832-2.944-3.456-2.944-2.656 0-3.296.672-3.296 2.752z"
        />
        <path
